...
#define LEDx_GPIO_CLK_DISABLE(__INDEX__)        __HAL_RCC_GPIOA_CLK_ENABLE() /* All Led on same port */
/**
  * @}
  */
...
#define BUTTON_SW1_EXTI_LINE                    EXTI_LINE_2
#ifdef CORE_CM0PLUS
#define BUTTON_SW1_EXTI_IRQn                    EXTI2_IRQn
#else
#define BUTTON_SW1_EXTI_IRQn                    EXTI2_IRQn
#endif
